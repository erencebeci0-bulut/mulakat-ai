...
export async function generateMetadata() {
  return {
    title: "Lc Waikiki Mağaza Müdürü Maaşı 2026 | Mülakat.com",
    description: "Lc waikiki mağaza müdürü maaşı hakkında en güncel veriler, profesyonel rehberler, ortalama fiyat aralıkları ve süreçler.",
    alternates: {
      canonical: "https://xn--mlakat-3ya.com/sirket/lc-waikiki-magaza-muduru-maasi"
    }
  };
}
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl text-gray-800">
      <nav className="text-sm mb-6 text-gray-500 font-medium">
        <Link href="/" className="hover:text-blue-600">Ana Sayfa</Link> &gt; <Link href="/maaslar" className="hover:text-blue-600">Maaslar</Link> &gt; <span className="text-gray-800">Lc Waikiki Mağaza Müdürü Maaşı 2026</span>
      </nav>

      
      <h1 className="text-3xl font-bold mb-6">Lc Waikiki Mağaza Müdürü Maaşı (2026 Güncel Veriler)</h1>
      ...
      <section className="mb-8">
        ...
        <div className="mb-4 bg-gray-50 p-4 rounded-lg">
          <h3 className="text-lg font-bold text-gray-800">Lc maaşı ne kadar?</h3>
      ...
      <section className="mt-12 p-6 bg-gray-50 rounded-xl border border-gray-200">
         ...
         <ul className="list-disc pl-5 space-y-2">
           <li><Link href="/meslek/satis-temsilcisi" className="text-blue-600 hover:text-blue-800 hover:underline font-medium">Satış temsilcisi</Link></li>
           <li><Link href="/mulakat/satis-temsilcisi-mulakat-sorulari" className="text-blue-600 hover:text-blue-800 hover:underline font-medium">Satış temsilcisi mülakat soruları</Link></li>
           <li><Link href="/mulakat/musteri-temsilcisi-mulakat-sorulari" className="text-blue-600 hover:text-blue-800 hover:underline font-medium">Müşteri temsilcisi mülakat soruları</Link></li>
         </ul>
      </section>
    </main>
  );
