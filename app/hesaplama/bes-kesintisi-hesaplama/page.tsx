...
export async function generateMetadata() {
  return {
    title: "Bes Kesintisi Hesaplama 2026 | Mülakat.com",
    description: "Bes kesintisi hesaplama hakkında en güncel veriler, profesyonel rehberler, ortalama fiyat aralıkları ve süreçler.",
    alternates: {
      canonical: "https://xn--mlakat-3ya.com/hesaplama/bes-kesintisi-hesaplama"
    }
  };
}
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl text-gray-800">
      <nav className="text-sm mb-6 text-gray-500 font-medium">
        <Link href="/" className="hover:text-blue-600">Ana Sayfa</Link> &gt; <Link href="/hesaplama" className="hover:text-blue-600">Hesaplama-araclari</Link> &gt; <span className="text-gray-800">Bes Kesintisi Hesaplama 2026</span>
      </nav>

      
      <h1 className="text-3xl font-bold mb-6">Bes Kesintisi Hesaplama 2026</h1>
