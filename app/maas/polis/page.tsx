...
export async function generateMetadata() {
  return {
    title: "Polis Maaşı 2026 | Mülakat.com",
    description: "Polis maaşı hakkında en güncel veriler, profesyonel rehberler, ortalama fiyat aralıkları ve süreçler.",
    alternates: {
      canonical: "https://xn--mlakat-3ya.com/maas/polis"
    }
  };
}
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl text-gray-800">
      <nav className="text-sm mb-6 text-gray-500 font-medium">
        <Link href="/" className="hover:text-blue-600">Ana Sayfa</Link> &gt; <Link href="/maaslar" className="hover:text-blue-600">Maaslar</Link> &gt; <span className="text-gray-800">Polis Maaşı 2026</span>
      </nav>

      
      <h1 className="text-3xl font-bold mb-6">Polis Maaşı (2026 Güncel Veriler)</h1>
      ...
      <section className="mb-8">
        ...
        <div className="mb-4 bg-gray-50 p-4 rounded-lg">
          <h3 className="text-lg font-bold text-gray-800">Polis maaşı ne kadar?</h3>
