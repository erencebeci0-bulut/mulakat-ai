...
export async function generateMetadata() {
  return {
    title: "Ui Ux Tasarımcı 2026 | Mülakat.com",
    description: "Ui ux tasarımcı hakkında en güncel veriler, profesyonel rehberler, ortalama fiyat aralıkları ve süreçler.",
    alternates: {
      canonical: "https://xn--mlakat-3ya.com/meslek/ui-ux-tasarimci"
    }
  };
}
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl text-gray-800">
      <nav className="text-sm mb-6 text-gray-500 font-medium">
        <Link href="/" className="hover:text-blue-600">Ana Sayfa</Link> &gt; <Link href="/meslekler" className="hover:text-blue-600">Meslekler</Link> &gt; <span className="text-gray-800">Ui Ux Tasarımcı 2026</span>
      </nav>

      
      <h1 className="text-3xl font-bold mb-6">Ui Ux Tasarımcı Nedir ve Nasıl Olunur?</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-3">Meslek Tanımı ve Sorumluluklar</h2>
        <p className="mb-4 text-gray-700">Ui Ux Tasarımcı, işletmelerin veya ürünlerin hedeflerine ulaşmasında oldukça stratejik görevler alır. İş akışlarını yönetmek, problemleri belirleyip çözüm üretmek ve çıktılardan sorumlu olmak temel görevlerindendir.</p>
      </section>
