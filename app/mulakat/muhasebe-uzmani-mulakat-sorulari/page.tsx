...
export async function generateMetadata() {
  return {
    title: "Muhasebe Uzmanı Mülakat Soruları 2026 | Mülakat.com",
    description: "Muhasebe uzmanı mülakat soruları hakkında en güncel veriler, profesyonel rehberler, ortalama fiyat aralıkları ve süreçler.",
    alternates: {
      canonical: "https://xn--mlakat-3ya.com/mulakat/muhasebe-uzmani-mulakat-sorulari"
    }
  };
}
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl text-gray-800">
      <nav className="text-sm mb-6 text-gray-500 font-medium">
        <Link href="/" className="hover:text-blue-600">Ana Sayfa</Link> &gt; <Link href="/mulakat" className="hover:text-blue-600">Mulakat-sorulari</Link> &gt; <span className="text-gray-800">Muhasebe Uzmanı Mülakat Soruları 2026</span>
      </nav>

      
      <h1 className="text-3xl font-bold mb-6">Muhasebe Uzmanı Mülakat Soruları</h1>
      ...
      <section className="mt-12 p-6 bg-gray-50 rounded-xl border border-gray-200">
         ...
         <ul className="list-disc pl-5 space-y-2">
           <li><Link href="/meslek/muhasebe-uzmani" className="text-blue-600 hover:text-blue-800 hover:underline font-medium">Muhasebe uzmanı</Link></li>
