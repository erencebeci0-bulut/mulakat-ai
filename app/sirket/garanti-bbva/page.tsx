...
export async function generateMetadata() {
  return {
    title: "Garanti Bbva 2026 | Mülakat.com",
    description: "Garanti bbva hakkında en güncel veriler, profesyonel rehberler, ortalama fiyat aralıkları ve süreçler.",
    alternates: {
      canonical: "https://xn--mlakat-3ya.com/sirket/garanti-bbva"
    }
  };
}
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl text-gray-800">
      <nav className="text-sm mb-6 text-gray-500 font-medium">
        <Link href="/" className="hover:text-blue-600">Ana Sayfa</Link> &gt; <Link href="/sirketler" className="hover:text-blue-600">Sirketler</Link> &gt; <span className="text-gray-800">Garanti Bbva 2026</span>
      </nav>

      
      <h1 className="text-3xl font-bold mb-6">Garanti Bbva Çalışma Kültürü ve Mülakat Süreci</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-3">Şirkete Genel Bakış</h2>
        <p className="mb-4 text-gray-700">Garanti bbva, faaliyet gösterdiği sektörde belirleyici kurumlardan biridir. Hızlı büyüyen ekipleri, yoğun operasyon süreçleri ve teknoloji odaklı yatırımlarıyla bilinir. Büyük bir çalışan ağına sahip olup yetenek çekme konusunda öncü şirketlerdendir.</p>
      </section>
