...
export async function generateMetadata() {
  return {
    title: "Resmi Tatil Çalışması 2026 | Mülakat.com",
    description: "Resmi tatil çalışması hakkında en güncel veriler, profesyonel rehberler, ortalama fiyat aralıkları ve süreçler.",
    alternates: {
      canonical: "https://xn--mlakat-3ya.com/is-hayati/resmi-tatil-calismasi"
    }
  };
}
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl text-gray-800">
      <nav className="text-sm mb-6 text-gray-500 font-medium">
        <Link href="/" className="hover:text-blue-600">Ana Sayfa</Link> &gt; <Link href="/is-hayati" className="hover:text-blue-600">Is-hayati</Link> &gt; <span className="text-gray-800">Resmi Tatil Çalışması 2026</span>
      </nav>

      
      <h1 className="text-3xl font-bold mb-6">Resmi Tatil Çalışması Hakkında Tüm Detaylar</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-3">Genel Bakış ve Mevzuat</h2>
        <p className="mb-4 text-gray-700">Çalışma hayatı içerisinde sıklıkla karşılaşılan <strong>resmi tatil çalışması</strong>, 4857 sayılı İş Kanunu başta olmak üzere çeşitli sosyal güvenlik yönetmelikleri ile çerçevelenmiş kritik haklardan biridir.</p>
      </section>
